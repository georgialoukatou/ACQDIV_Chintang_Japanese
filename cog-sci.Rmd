...
Anova(lm(token_fscore ~ language * level, data[ which(data$subalgorithm =='AGu'),]), type=3)
Anova(lm(token_fscore ~ language * level, data[ which(data$subalgorithm =='BTP_abs'),]), type=3)
Anova(lm(token_fscore ~ language * level, data[ which(data$subalgorithm =='FTP_abs'),]), type=3)
Anova(lm(token_fscore ~ language * level, data[ which(data$subalgorithm =='BTP_rel'),]), type=3)
Anova(lm(token_fscore ~ language * level, data[ which(data$subalgorithm =='BTP_rel'),]), type=3)
Anova(lm(token_fscore ~ language * level, data[ which(data$subalgorithm =='DiBS'),]), type=3)
