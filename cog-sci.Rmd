...
```{r tab:meanscores, echo=FALSE}
scores_full<-matrix( c(data[ which(data$language =='Chintang' & data$level =="word"),]$fscore, data[ which(data$language =='Chintang' & data$level =="morphemes"),]$fscore, data[ which(data$language =='Japanese' & data$level =="word"),]$fscore,data[ which(data$language =='Japanese' & data$level =="morphemes"),]$fscore), nrow=9, ncol=4, byrow=FALSE)
