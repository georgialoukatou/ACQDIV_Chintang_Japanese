...
write.table(matrix, "~/Desktop/deleteme.txt", row.names=FALSE, col.names=c("Algorithms", "word Chintang", "word Japanese", "morpheme Chintang", "morphemes Japanese"),sep="\t&\t", quote = F )
